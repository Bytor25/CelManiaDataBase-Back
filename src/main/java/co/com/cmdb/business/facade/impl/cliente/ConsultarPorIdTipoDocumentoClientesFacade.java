...
import co.com.cmdb.business.usecase.impl.cliente.ConsultarPorIdTipoDocumentoCliente;
...
public class ConsultarPorIdTipoDocumentoClientesFacade implements FacadeWithReturn<ClienteDTO, ClienteDTO> {
	
	private DAOFactory daoFactory;
	
	public ConsultarPorIdTipoDocumentoClientesFacade() {
	...
	public ClienteDTO execute(ClienteDTO dto) {
        ...
        try {
            var useCase = new ConsultarPorIdTipoDocumentoCliente(daoFactory);
